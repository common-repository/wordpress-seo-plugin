	...
	$fields['internal'] = array(
		...
		'options' => array(
			...
			array(
				...
				<div class="error below-h2"><p><a title="Upgrade Now" href="http://premium.wpmudev.org/project/wpmu-dev-seo">Upgrade to WPMU DEV SEO Pro to enable this feature</a></p></div>
				'
			),
			array(
				'type' => 'checkbox',
