...
function wds_sitemaps_settings() {
	...
	<p>(Leaving these off of a sitemap won\'t guarantee that a search engine won\'t find the information by other means!)</p>
	<div class="error below-h2"><p><a title="Upgrade Now" href="http://premium.wpmudev.org/project/wpmu-dev-seo">In this version, only 20 latest items will be included in sitemaps. Upgrade to WPMU DEV SEO Pro to get rid of this limit</a></p></div>
	', 'wds' );
