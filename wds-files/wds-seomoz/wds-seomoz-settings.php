...
function wds_seomoz_settings() {
	...
	$fields = array(
		'authentication' => array(
			...
			'intro' => '<div class="error below-h2"><p><a title="Upgrade Now" href="http://premium.wpmudev.org/project/wpmu-dev-seo">Upgrade to WPMU DEV SEO Pro to allow access to SEOmoz API</a></p></div>',
			'options' => array(
				array(
					'type' => 'text_disabled',
					'name' => 'access-id',
...
<p>' . __( 'For posts / pages specific metrics refer to the SEOmz URL metrics module on the Edit Post / Page screen,' , 'wds') . '</p>
