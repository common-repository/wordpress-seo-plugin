...
?>
			<div id="snippet">
				...
				<p style="font-size: 12px; color: #000; line-height: 15px; width:540px;"><?php echo $date; ?><span><?php echo $desc ?></span></p>
...
/* ========== Display helpers ========== */
	...
	function show_title_row () {
		...
		$value = wds_get_value('title');
		$field = "<input type='text' id='wds_title' name='wds_title' value='{$value}' class='wds' />";
	...
	function show_metadesc_row () {
		...
		$value = wds_get_value('metadesc');
		$field = "<textarea rows='2' name='wds_metadesc' id='wds_metadesc' class='wds'>{$value}</textarea>";
